...
<body>
    ...
    <section class="news">
        <article>
            <h2>Título da Notícia de Entretenimento 1</h2>
            <p>Descrição da notícia de entretenimento.</p>
            <a href="#">Leia mais...</a>
        </article>
        <article>
            <h2>Título da Notícia de Entretenimento 2</h2>
            <p>Descrição da notícia de entretenimento.</p>
            <a href="#">Leia mais...</a>
        </article>
        <article>
            <h2>Título da Notícia de Entretenimento 3</h2>
            <p>Descrição da notícia de entretenimento.</p>
            <a href="#">Leia mais...</a>
        </article>
    </section>
